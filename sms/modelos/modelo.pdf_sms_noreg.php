...
class pdf_sms_noreg extends FPDF
{
	...
	function Header()
	{
            ...
            $this->Cell(0,5,'LISTADO DESTINATARIOS NO REGISTRADOS',0,0,'C');
            $this->Ln(10);
			$this->SetFillColor(169,169,169) ;
            $this->SetTextColor(1);           
            $this->Cell(35,5,utf8_decode("Teléfono"),1,0,'C',1);
            $this->Cell(70,5,"Nombres",1,0,'C',1);
            $this->Cell(60,5,"Grupos",1,0,'C',1);
            $this->Cell(90,5,utf8_decode("Observación"),1,0,'C',1);
            $this->Ln();
